...
input int MinOrdersDistance1 = 100;        //Min orders distance (grid 1)
...
input int MinOrdersDistance2 = 100;           //Min orders distance (grid 2)
...
input int MinOrdersDistance4 = 100;           //Min orders distance (grid 4)
