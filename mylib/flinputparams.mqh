...
input double LotFactor1 = 1.1;            //Volume factor (grid 1)
input double LotHedge1 = 2.5;               //Hedge volume (grid 1)
//input bool HedgeMode1 = true;             //Hedge mode (grid 1)
...
input double LotFactor2 = 1.1;               //Volume factor (grid 2)
...
input int HedgeProfitFactor2 = 5;             //Hedge profit factor,% (grid 2)

//grid 3
input double FirstLot3 = 0.1;                //First lot (grid 3)
input double LotFactor3 = 1.1;               //Volume factor (grid 3)
...
input int HedgeProfitFactor3 = 5;             //Hedge profit factor,% (grid 3)

//grid 4
input double FirstLot4 = 0.1;                //First lot (grid 4)
input double LotFactor4 = 1.1;               //Volume factor (grid 4)
...
input int HedgeProfitFactor4 = 5;             //Hedge profit factor,% (grid 4)

//grid 5
input double FirstLot5 = 0.1;                //First lot (grid 5)
input double LotFactor5 = 1.1;               //Volume factor (grid 5)
...
input int HedgeProfitFactor5 = 5;             //Hedge profit factor,% (grid 5)

//grid 6
input double FirstLot6 = 0.1;                //First lot (grid 6)
input double LotFactor6 = 1.1;               //Volume factor (grid 6)
...
input int HedgeProfitFactor6 = 5;             //Hedge profit factor,% (grid 6)

//grid 7
input double FirstLot7 = 0.1;                //First lot (grid 7)
input double LotFactor7 = 1.1;               //Volume factor (grid 7)
...
input int HedgeProfitFactor7 = 5;             //Hedge profit factor,% (grid 7)

//grid 8
input double FirstLot8 = 0.1;                //First lot (grid 8)
input double LotFactor8 = 1.1;               //Volume factor (grid 8)
...
input int HedgeProfitFactor8 = 5;             //Hedge profit factor,% (grid 8)

//grid 9
input double FirstLot9 = 0.1;                //First lot (grid 9)
input double LotFactor9 = 1.1;               //Volume factor (grid 9)
...
input int HedgeProfitFactor9 = 5;             //Hedge profit factor,% (grid 9)

//grid 10
input double FirstLot10 = 0.1;                //First lot (grid 10)
input double LotFactor10 = 1.1;               //Volume factor (grid 10)
...
input int HedgeProfitFactor10 = 5;             //Hedge profit factor,% (grid 10)
//---------------------------------------------------------------------------------
